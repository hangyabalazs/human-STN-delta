function labels_colors = defineLabelsColors_pd
...
%   Edit log: AK 7/01, BH 6/24/11, JSz 10/2024
...
labels_colors = { ...
        ...
        'TrialType=1',                 'Valószín? jutalom',               [0 1 0],        [],       '-';   ...
        'TrialType=2',                'Valószín? büntetés',       [1 0 0],        [],       '-';   ...
        ...
        'StopPartition=1',                   'FailedStop',     [1 0 0],        [],       '-';   ...
        'StopPartition=2',                   'SuccesfulStop',   [0 1 0],           [],       '-';   ...
        'RTpartition=1',                   'LongRT',            [0.5 1 0],        [],       '-';   ...
        'RTpartition=2',                   'ShortRT',           [0 0.5 0.5],           [],       '-';   ...
        'CuepairPartition=1'               'Ord',               [0.01 0.42 0.77],           [],       '-';   ...
        'CuepairPartition=2'               'OrdSkip',           [0.36 0.01 0.77],           [],       '-';   ...
        'CuepairPartition=3'               'Rev',              [0.65 0.01 0.77],           [],       '-';   ...
        'CuepairPartition=4'               'RevSkip',           [0.8 0.29 0.48],           [],       '-';   ...
        'CuepairPartition=11'               'AllOrd',            [0.01 0.42 0.77],           [],       '-';   ...
    };
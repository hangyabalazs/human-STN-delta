function [DM LrC valid_channels] = LRatio_pd_ssrt(cellid,feature_names,valid_channels)
...
sesspath = cellid2fnames(cellid,'Session');

Nttfn = fullfile(sesspath,['Ch' num2str(t) '.mat']);
